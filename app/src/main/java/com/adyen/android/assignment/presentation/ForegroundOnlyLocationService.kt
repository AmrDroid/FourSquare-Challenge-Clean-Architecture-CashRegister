...
import com.adyen.android.assignment.presentation.main.MainActivity
...
class ForegroundOnlyLocationService : Service() {
    ...
    override fun onCreate() {
        ...
        locationRequest.apply {
            ...
            smallestDisplacement = 1000f //To avoid unnecessary updates when smallest displacement is under 100 meters
    ...
    override fun onBind(intent: Intent): IBinder {
        ...
        // VenuesFragm comes into foreground and binds to service, so the service can become a background services.
        stopForeground(true)
    ...
    override fun onRebind(intent: Intent) {
        ...
        // VenuesFragm returns to the foreground and rebinds to service, so the service can become a background services.
        stopForeground(true)
        serviceRunningInForeground = false
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        // Ensures onRebind() is called if VenuesFragm rebinds.
        return true
    }
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val mainNotificationText = location?.toText() ?: getString(com.adyen.android.assignment.R.string.no_current_location)
    ...
    companion object {
        ...
        private const val PACKAGE_NAME = "com.adyen.android.assignment"
        private const val NOTIFICATION_ID = 100017
        private const val NOTIFICATION_CHANNEL_ID = "forsquare_channel_01"
